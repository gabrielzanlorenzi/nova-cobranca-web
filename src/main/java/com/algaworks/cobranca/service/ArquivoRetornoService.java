...
public class ArquivoRetornoService {
	...
	private List<String> carregarMensagens(ArquivoRetorno arquivoRetorno) {
		...
		mensagens.add("Número de títulos em combrança do banco: " + sumario.getQuantidadeDeTitulosEmCobranca());
		mensagens.add("Valor totaol de títulos: " + DecimalFormat.MONEY_DD_BR.format(sumario.getValorTotalEmCobranca()));
		return mensagens;
	}

	private ArquivoRetorno criarArquivoRetorno(String fileName, InputStream inputstream)
